...
*** Test Cases ***
T - FDA APP - Android - application.log_out
    ...
    Y hagamos la busqueda de los datos en el CDP del evento    log_out
    Entonces podremos ver que la estructura del evento en cuestion es correcta

T - FDA APP - Android - application.forgot_passwd
    Dado que ingresamos a la aplicacion de Farmacias del ahorro y pasamos el onboarding
    Cuando intentemos recuperar contrasena
    Y hagamos la busqueda de los datos en el CDP del evento    forgot_passwd
    Entonces podremos ver que la estructura del evento en cuestion es correcta

T - FDA APP - Android - application.login_tap
    Dado que ingresamos a la aplicacion de Farmacias del ahorro y pasamos el onboarding
    Cuando hagamos login en el aplicativo
    Y hagamos la busqueda de los datos en el CDP del evento    login_tap
    Entonces podremos ver que la estructura del evento en cuestion es correcta

T - FDA APP - Android - application.login
    Dado que ingresamos a la aplicacion de Farmacias del ahorro y pasamos el onboarding
    Cuando hagamos login en el aplicativo
    Y hagamos la busqueda de los datos en el CDP del evento    login
    Entonces podremos ver que la estructura del evento en cuestion es correcta

T - FDA APP - Android - application.sign_up_tap
    Dado que ingresamos a la aplicacion de Farmacias del ahorro y pasamos el onboarding
    Cuando intentemos crear una nueva cuenta
    Y hagamos la busqueda de los datos en el CDP del evento    sign_up_tap
    Entonces podremos ver que la estructura del evento en cuestion es correcta
